    ...
    >
      {copiedField === field ? (
        <>
          ...
          <div className="hidden sm:block">Copied!</div>
        </>
      ) : (
        <>
        ...
        <>
          ...
          <div className="space-y-4">
            <div className="border border-slate-200 rounded-lg p-4">
              <div className="flex flex-row justify-between items-center gap-3 mb-2 sm:items-center sm:justify-between">
              ...
              <div className="flex flex-row items-center justify-between gap-3">
                ...
                <button
                  ...
                  className={`${primaryActionClassName} sm:w-auto`}
                >
            ...
            {hasPassword ? (
              <div className="border border-slate-200 rounded-lg p-4">
                <div className="flex flex-row justify-between items-center gap-3 mb-2 sm:items-center sm:justify-between">
                  ...
                  <div className="flex flex-row gap-3 items-center justify-end sm:items-center w-full sm:w-auto">
                    <button
                      onClick={onRegeneratePassword}
                      type="button"
                      disabled={isRegeneratingPassword}
                      className={`${secondaryActionClassName} sm:w-auto`}
                    >
                      <RefreshCw
