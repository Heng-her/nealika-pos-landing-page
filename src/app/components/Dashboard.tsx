...
import {Check, Copy, Edit2, Eye, EyeOff, Key, LogOut, Settings, User, Wallet} from 'lucide-react';
...
export default function Dashboard({onLogout}: DashboardProps) {
    const [activeTab, setActiveTab] = useState<'profile' | 'services' | 'payments' | 'access'>('profile');
    ...
    const [subscribedPackageId, setSubscribedPackageId] = useState<number | null>(1); // User is subscribed to Starter by default
    ...
    const handleUnsubscribe = () => {
        const packageName = services.find(s => s.id === subscribedPackageId)?.name;
    ...
    const handleCheckoutComplete = () => {
        if (checkoutPackage) {
            const isUpgrade = subscribedPackageId && checkoutPackage.id > subscribedPackageId;
            const isDowngrade = subscribedPackageId && checkoutPackage.id < subscribedPackageId;
            const actionText = isUpgrade ? 'upgraded' : isDowngrade ? 'downgraded' : 'subscribed';

            setSubscribedPackageId(checkoutPackage.id);
            setCheckoutPackage(null);
            setActiveTab('services');
            alert(`Payment successful! You have ${actionText} to ${checkoutPackage.name}.`);
        }
    };
                ...
                <div className="grid lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-3">
                                ...
                                {!isEditingProfile ? (
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                <label className="text-sm font-medium text-slate-500">Business
                                                    Name</label>
                                        ...
                                        {subscribedPackageId && (
                                            <div className="bg-white rounded-xl shadow-sm p-6">
                                                <div className="flex items-center justify-between mb-4">
                                                    <h3 className="text-xl font-bold text-slate-900">Current
                                                        Subscription</h3>
                                                    <span
                                                ...
                                                <div className="grid md:grid-cols-2 gap-6">
                                                    <div>
                                                        ...
                                                        <p className="text-lg font-semibold text-slate-900">
                                                            {services.find(s => s.id === subscribedPackageId)?.name}
                                                        </p>
                                                    </div>
                                                    <div>
                                                        <p className="text-sm text-slate-500 mb-1">Subscribe Date</p>
                                                        <p className="text-lg font-semibold text-slate-900">
                                                            {new Date(subscriptionDetails.subscribedDate).toLocaleDateString('en-US', {
                                                                year: 'numeric',
                                                                month: 'long',
                                                                day: 'numeric'
                                                            })}
                                ...
                                {subscriptionDetails.autoRenew ? 'ON' : 'OFF'}
                                                            ...
                                                            <button
                                                                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                                                                    subscriptionDetails.autoRenew ? 'bg-green-600' : 'bg-slate-300'
                                                                }`}
                                                            >
                                <span
                                    className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                                        subscriptionDetails.autoRenew ? 'translate-x-6' : 'translate-x-1'
                                    }`}
                                />
                                                            </button>
                                                        </div>
                                                ...
                                                <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                                                    <p className="text-sm text-blue-900">
                                                        <strong>Next billing
                                                            date:</strong> {new Date(subscriptionDetails.expiryDate).toLocaleDateString('en-US', {
                                                        year: 'numeric',
                                                        month: 'long',
                                                        day: 'numeric'
                                                    })}
                                        ...
                                        <div className="bg-white rounded-xl shadow-sm p-6">
                                            <div className="mb-6">
                                                <h2 className="text-2xl font-bold text-slate-900 mb-2">POS Packages</h2>
                                                <p className="text-slate-600">Choose the perfect package for your
                                                    business needs</p>
                                            </div>
                                            ...
                                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                                                {services.map((service) => {
                                                    ...
                                                    const canUpgrade = subscribedPackageId && service.id > subscribedPackageId;
                                                    const canDowngrade = subscribedPackageId && service.id < subscribedPackageId;
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <div className="flex gap-2 mb-3">
                                                                {service.name === 'Professional Package' && !isSubscribed && (
                                                                    <span
                                  ...
                                  Most Popular
                                                                ...
                                                                {isSubscribed && (
                                                                    <span
                                                                        className="inline-block px-3 py-1 bg-green-600 text-white text-xs font-semibold rounded-full">
                                  Active
                                </span>
                                                                )}
                                                            </div>
                                                            ...
                                                            <div className="mb-3">
                                                                <span
                                                                    className="text-3xl font-bold text-slate-900">${service.price}</span>
                                                                <span className="text-slate-600">{service.period}</span>
                                                            </div>
                                                            <p className="text-slate-600 text-sm mb-4">{service.description}</p>
                                                            <div className="mb-4">
                                                                <p className="text-sm font-medium text-slate-700">{service.maxRegisters}</p>
                                                            </div>
                                        ...
                                        <div className="mb-6">
                                            <div className="flex items-start justify-between mb-4">
                                                <div>
                                                    ...
                                                    <p className="text-lg text-slate-600">{selectedServiceDetail.description}</p>
                                                </div>
                                        ...
                                        <div className="grid md:grid-cols-3 gap-6 mb-8">
                                            <div className="bg-blue-50 rounded-lg p-6">
                                                ...
                                                <div className="flex items-baseline gap-1">
                                                    <p className="text-4xl font-bold text-blue-600">${selectedServiceDetail.price}</p>
                                                    <p className="text-lg text-slate-600">{selectedServiceDetail.period}</p>
                                                </div>
                                            </div>
                                            <div className="bg-purple-50 rounded-lg p-6">
                                                <p className="text-sm text-slate-600 mb-2">Registers</p>
                                                <p className="text-2xl font-bold text-purple-600">{selectedServiceDetail.maxRegisters}</p>
                                            </div>
                                            <div className="bg-green-50 rounded-lg p-6">
                                                <p className="text-sm text-slate-600 mb-2">Features</p>
                                                <p className="text-4xl font-bold text-green-600">{selectedServiceDetail.features.length}</p>
                                            </div>
                                        </div>

                                        <div className="border-t pt-6 mb-8">
                                            <h3 className="text-xl font-bold text-slate-900 mb-4">Package Features</h3>
                                        ...
                                        <div className="border-t pt-6">
                                            ...
                                            <div className="grid md:grid-cols-3 gap-6">
                                                <div>
                                                    ...
                                                    <p className="text-slate-900 mt-1">#{selectedServiceDetail.id}</p>
                                                </div>
                                                <div>
                                                    <p className="text-sm font-medium text-slate-500">Category</p>
                                                    <p className="text-slate-900 mt-1">{selectedServiceDetail.category}</p>
                                                </div>
                                                <div>
                                                    <p className="text-sm font-medium text-slate-500">Status</p>
                                                    <span
                                                        className="inline-block px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm font-medium mt-1">
                            Active
                          </span>
                                                </div>
                                            </div>
                                        ...
                                        {selectedServiceDetail.id === subscribedPackageId && (
                                            <div className="border-t pt-6 mt-6">
                                                <h3 className="text-xl font-bold text-slate-900 mb-4">Subscription
                                                    Details</h3>
                                                <div className="grid md:grid-cols-2 gap-6">
                                                    <div>
                                                        <p className="text-sm font-medium text-slate-500">Subscribe
                                                            Date</p>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-slate-900 mt-1">{subscriptionDetails.duration}</p>
                                                    </div>
                                                    <div>
                                                        <p className="text-sm font-medium text-slate-500">Expiry
                                                            Date</p>
                                                        <p className="text-slate-900 mt-1">
                                                            {new Date(subscriptionDetails.expiryDate).toLocaleDateString('en-US', {
                                                                year: 'numeric',
                                                    ...
                                                    <div>
                                                        <p className="text-sm font-medium text-slate-500">Auto-Renew</p>
                                                        <p className="text-slate-900 mt-1">
                                            ...
                                            {selectedServiceDetail.id === subscribedPackageId ? (
                                                ...
                                                <button
                                                    ...
                                                    className={`w-full px-6 py-3 text-white rounded-lg transition-colors font-semibold ${
                                                        subscribedPackageId && selectedServiceDetail.id > subscribedPackageId
                        ...
                        {activeTab === 'access' && (
                            <div className="bg-white rounded-xl shadow-sm p-6">
                                <div className="mb-6">
                                    <h2 className="text-2xl font-bold text-slate-900 mb-2">Access Information</h2>
                                    <p className="text-slate-600">Your POS system credentials and access details</p>
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="border border-slate-200 rounded-lg p-4">
                                        <div className="flex items-center justify-between mb-2">
                                            <label className="text-sm font-medium text-slate-500">POS URL</label>
                                            <button
                                    ...
                                    <div className="border border-slate-200 rounded-lg p-4">
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <button
                                                onClick={() => handleCopyToClipboard(accessInfo.username, 'username')}
                                                className="flex items-center gap-1 text-blue-600 hover:text-blue-700 text-sm"
                                            >
                                    ...
                                    <div className="border border-slate-200 rounded-lg p-4">
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <button
                                                    onClick={() => handleCopyToClipboard(accessInfo.password, 'password')}
                                                    className="flex items-center gap-1 text-blue-600 hover:text-blue-700 text-sm"
                                                >
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-amber-800">
                                                Keep your credentials secure and do not share them with unauthorized
                                                users.
