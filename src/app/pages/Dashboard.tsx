...
import ProfilePage, { type ProfileFormState } from "../components/ProfilePage";
import AccessInfoPage from "../components/AccessInfoPage";
...
import {
  ...
  isAutoRenewEnabled,
  getDaysUntilDate,
  getReminderChannelLabels,
  readStoredReminderPreference,
  writeStoredReminderPreference,
...
export default function Dashboard({ onLogout }: DashboardProps) {
  ...
  let activeTab: "profile" | "services" | "payments" | "access" = "profile";
  if (searchParams.has("pos-access")) {
    activeTab = "access";
  } else if (searchParams.has("package")) {
    activeTab = "services";
  } else if (searchParams.has("payment")) {
    activeTab = "payments";
  } else if (searchParams.has("profile")) {
    activeTab = "profile";
  }

  const setActiveTab = (tabName: "profile" | "access" | "services" | "payments") => {
    let query = "";
    if (tabName === "profile") {
      query = "?profile";
